...
figure(4); clf
subplot(1,3,1)
imshow(I_norm1 > UpperThreshold(I_norm1))
subplot(1,3,2)
imshow(I_norm2 > UpperThreshold(I_norm2))
subplot(1,3,3)
imshow(I_norm3 > UpperThreshold(I_norm3))

%%

image = uint8(I_norm1);
[binCounts, ~] = histcounts(I_norm1, 0:256);

UpperThreshold(I_norm2)
